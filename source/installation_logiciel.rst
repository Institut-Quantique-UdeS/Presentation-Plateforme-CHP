...
.. code-block:: bash
    ...
    git checkout v2.3.1 #check the latest version (December 1st, 2023)
    module load StdEnv/2020 gcc/9.3.0 cmake/3.23.1 python/3.10 flexiblas/3.0.4 eigen/3.4.0 scipy-stack
    virtualenv env_qcm --no-download #create virtual environment
    source env_qcm/bin/activate #activate it
